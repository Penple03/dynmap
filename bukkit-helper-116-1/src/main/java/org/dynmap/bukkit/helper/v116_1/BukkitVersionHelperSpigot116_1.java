package org.dynmap.bukkit.helper.v116_1;
...
import org.dynmap.bukkit.helper.v116_1.MapChunkCache116_1;
 ...
 */
public class BukkitVersionHelperSpigot116_1 extends BukkitVersionHelperCB {
    ...
    public BukkitVersionHelperSpigot116_1() {
    ...
    public void initializeBlockStates() {
    	...
    	for (int i = 0; i < cnt; i++) {
    		...
    		if (bd.getBlock() instanceof BlockRotatable) {
    			bs.setLog();
    		}
    		if (mat.isSolid()) {
    			bs.setSolid();
    ...
    public MapChunkCache getChunkCache(BukkitWorld dw, List<DynmapChunk> chunks) {
        MapChunkCache116_1 c = new MapChunkCache116_1();
	...
	public int getBiomeBaseWaterMult(Object bb) {
		return (int) getFieldValue(getFieldValue(bb, biomefog, null), biomebasewatercolor, -1);
	}
